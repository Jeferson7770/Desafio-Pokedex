...
class FinancialReportSummary(models.Model):
    ...
    expenses_payroll = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, verbose_name="Pessoas/Folha")
    expenses_taxes = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, verbose_name="Impostos")
    expenses_structure = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, verbose_name="Estrutura/Escritório")
    expenses_late_interest = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, verbose_name="Juros por Atraso")
